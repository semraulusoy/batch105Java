...
// - hicbirini icermiyorsa "cok calisman lazim" yazdirin
        ...
        // buyuk kucuk harf duyarliligi olmasin istersek
        // orjinal cumleyi bozmadan yapmak istersek
        // yeni bir variable olustururuz.

        String cumleCopy =cumle.toLowerCase();
        if(cumleCopy.contains("ev") && cumleCopy.contains("is")){
            System.out.println("hemn ev lazim hem is");
